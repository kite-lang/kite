...
The type-checker will validate that an annotated type is at least as general as the inferred type. This means that a type annotation of \code{a} will match anything, and \code{:: a -> a} will match {:: Int -> Int} but not \code{:: Int -> Bool}
