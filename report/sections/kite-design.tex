...
expression is returned. Each block
has its own immediate scope.

Since everything in Kite is an expression, functions are simply a variable bound to a given anonymous function. A function is declared as follows:
