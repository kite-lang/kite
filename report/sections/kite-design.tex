...
As mentioned earlier in the report (TODO: ref), the `Foundation' of Kite is a standard library implemented in Kite, consisting of often used functions. Kite's \nameref{foundation}) is inspired by Haskell's `Prelude', and includes many functions found in Prelude.
